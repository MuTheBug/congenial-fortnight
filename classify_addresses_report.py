...
AREA_DEFINITIONS = [
    ("الرمل الجنوبي", "Al-Raml Al-Janoubi (South Sand)", [
        ...
        "نزلة الرمل", "الغراف", "شارع الغراف", "غراف",
    ]),
    ("الرمل الفلسطيني", "Al-Raml Al-Filastini (Palestinian Sand)", [
        "الرمل الفلسطيني", "رمل الفلسطيني", "رمل لفلسطيني", "رمل فلسطيني",
    ]),
    ("مسبح الشعب", "Masbah Al-Sha'b (People's Pool)", [
    ...
    ("بساتين الريحان", "Basateen Al-Raihan", [
        "بساتين الريحان", "بساتين ريحان", "بستان الريحان", "بستاتين الريحان",
    ]),
    ("بستان الصيداوي", "Bustan Al-Saydawi", [
        "بستان الصيداوي", "الصيداوي",
    ]),
    ("بستان الحميمي", "Bustan Al-Humaimmi", [
        "بستان الحميمي", "بستان الحمامي", "بستان الحمامة", "حمامي",
    ]),
    ("بستان السمكة", "Bustan Al-Samaka", [
    ...
    ("حي القدس", "Hay Al-Quds (Jerusalem Quarter)", [
        "حي القدس",
    ]),
    ...
    ("عين التمرة", "Ain Al-Tamara", [
        "عين التمرة", "عين تمره",
    ]),
    ("الشاليهات الجنوبية", "Southern Chalets", [
